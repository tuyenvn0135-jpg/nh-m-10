<footer class="bg-[#0A2540] text-gray-400 text-xs pt-12 pb-6 border-t border-slate-800 mt-20">
        <div class="container mx-auto px-4 max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                ...
                <div class="flex">
                    <input type="email" id="subscriber-email" placeholder="Email của bạn..." class="bg-slate-800 px-3 py-2 text-white rounded-l focus:outline-none w-full">
                    <button onclick="handleSubscribe()" class="bg-[#FF9F1C] text-black font-bold px-4 rounded-r hover:bg-orange-500">Gửi</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        // THÊM CHỨC NĂNG: Xử lý khi nhấn nút gửi Email nhận tin khuyến mãi
        function handleSubscribe() {
            ...
            // Hiện thông báo thành công đẹp đẽ giống như hệ thống KingFisher
            alert('🎉 Đăng ký nhận tin thành công! KingFisher sẽ gửi các chương trình khuyến mãi và mẹo chọn mồi câu sớm nhất qua email: ' + emailValue);
            
            // Xóa sạch ô nhập sau khi gửi thành công
            emailInput.value = '';
        }
