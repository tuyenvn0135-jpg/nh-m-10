...
<span class="text-slate-400">Chào, <a href="/MID/profile.php" class="text-yellow-400 font-bold hover:underline">👤 <?php echo $_SESSION['fullname'] ?? 'Cần thủ'; ?></a> htmlspecialchars($_SESSION['fullname']); ?></a></span>
