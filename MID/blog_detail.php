...
<div class="container mx-auto px-4 py-10 max-w-3xl">
    <div class="text-[11px] text-gray-400 mb-4 font-medium">
        <a href="/kingfisher/index.php" class="hover:underline">Trang chủ</a> / 
        <a href="/kingfisher/MID/blog.php" class="hover:underline">Cẩm Nang Cần Thủ</a> / 
    ...
    <article class="bg-white p-6 md:p-8 rounded-xl border shadow-sm" data-aos="fade-up">
        ...
        <div class="border-t pt-6 mt-8 text-center">
            <a href="/kingfisher/MID/blog.php" class="inline-block bg-[#0A2540] text-white font-bold px-6 py-2.5 rounded-lg text-xs uppercase tracking-wider hover:bg-slate-800 transition">
