...
try {
    ...
    echo "<h2>⚠️ LỖI HỆ THỐNG (ADMIN PRODUCTS):</h2>";
    echo "<b>Nội dung:</b> " . $e->getMessage();
    echo "</div>";
    die();
}
?>
    ...
    <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col justify-between hidden md:flex shrink-0">
        <div>
            ...
            <nav class="p-4 space-y-2 text-sm font-medium">
                ...
                <a href="admin_contacts.php" class="block hover:bg-slate-800 hover:text-white px-4 py-3 rounded transition flex items-center gap-2">💬 Quản lý Liên Hệ</a>
