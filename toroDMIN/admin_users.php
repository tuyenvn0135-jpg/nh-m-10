...
// 1. SỬA LỖI OPEN_BASEDIR: Dùng đường dẫn tuyệt đối an toàn cho InfinityFree
...
if (isset($_GET['change_role_id']) && isset($_GET['new_role'])) {
    ...
    // 2. SỬA LỖI 404 TẠI ĐÂY: Chuyển hướng trực tiếp trong cùng thư mục, bỏ chữ toroDMIN/ đi
